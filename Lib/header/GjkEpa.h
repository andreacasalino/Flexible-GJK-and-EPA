...
/** @brief When enabling this compiler definition, every time that a query is performed,
 * a log file containing the iterations perormed by GjkEpa is created.
 * This has just the aim of debugging the solver when needed.
 */
...
namespace flx { 
	...
	public:
		 ...
		 * IMPORTANT!!!! this method is not thread safe: use different GjkEpa solvers to implement multi-threading strategies
		 */
		 ...
		 *        The norm of the difference of these 2 vectors represent the distance between the shapes.
		 *
		 * 		- if the shapes are in collision is the penetration vector
		 *        The norm of the difference of these 2 vectors represent the penetration depth.
		 *
