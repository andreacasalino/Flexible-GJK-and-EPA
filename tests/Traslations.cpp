...
//     flx::shape::TransformDecorator shape_b(make_prism_cloud_ptr(polygon_b,
//     1),
...
//     REQUIRE(query.is_closest_pair_or_penetration_info);
//     CHECK(flx::almost_equal(flx::delta_squared_lenght(query.result), 10 *
//     10));
//   }
...
//     REQUIRE(!query.is_closest_pair_or_penetration_info);
//     CHECK(
//         flx::almost_equal(flx::delta_squared_lenght(query.result), 0.3 *
//         0.3));
//   }
// }
