...
//                              MinkowskiPair(tetra[0].vertexA,
//                              tetra[0].vertexB));
//     ++it;
//     originalVertices.emplace(&(*it),
//                              MinkowskiPair(tetra[1].vertexA,
//                              tetra[1].vertexB));
//     ++it;
//     originalVertices.emplace(&(*it),
//                              MinkowskiPair(tetra[2].vertexA,
//                              tetra[2].vertexB));
//     ++it;
//     originalVertices.emplace(&(*it),
//                              MinkowskiPair(tetra[3].vertexA,
//                              tetra[3].vertexB));
//   }
...
//   float coeff[3];
//   getClosestInTriangle(*closestToOrigin->first->A,
//   *closestToOrigin->first->B,
//                        *closestToOrigin->first->C, coeff);
//   const MinkowskiPair *originalFacet[3];
//   originalFacet[0] =
//   &originalVertices.find(closestToOrigin->first->A)->second; originalFacet[1]
//   = &originalVertices.find(closestToOrigin->first->B)->second;
//   originalFacet[2] =
//   &originalVertices.find(closestToOrigin->first->C)->second;
...
//       diff(Delta, initialVertices[3].vertexDiff,
//       initialVertices[0].vertexDiff); if (dot(Delta, searchDirection) <=
